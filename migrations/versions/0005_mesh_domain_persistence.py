...
Downgrade preflights both integrated immutable-data categories before any mesh
DDL. This protects a database stamped with both independent ``0005`` heads,
where Alembic can enter this predecessor without visiting the merge revision.
"""
